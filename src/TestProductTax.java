...
public class TestProductTax {
    ...
    public static Collection<Object[]> getParameters() {
        ...
        Product product1 = new Product("Celular", "UNI", 100.00, calc);
        Product product2 = new Product("Laptop", "UNI", 2000.00, calc);
        Product product3 = new Product("teclado", "UNI", 157.00, calc);

        // Prepare test cases
        Object[][] testData = new Object[][] {
                // Produto , entereço , valor do ICMS sobre o produto, valor da Taxa Municipal
                // "0.0" caso DF
                // endereço 1 "GO"
