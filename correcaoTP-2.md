...
- Refatoração 3:   
  - Critério 1:  Ok 
  - Critério 2:  NOk - Não foi criado um atributo na classe FreightCalculator
    como referencia para a classe de origem, o método
    FreightCalculator::calculateFreight continua com variáveis temporárias (não
    foram criados atributos na classe para eliminá-los). - 40 pontos.
  - Critério 3:  Ok 
